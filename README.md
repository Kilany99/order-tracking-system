...
A microservices-based real-time order tracking system built with .NET 7, implementing CQRS and DDD patterns. The system provides real-time order tracking, driver assignment, and notifications for both customers and drivers.
